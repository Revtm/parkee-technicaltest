            ...
            <div className="mx-10 mt-10 flex flex-row gap-4">
                <div className="form basis-2/3 p-3 rounded-md flex flex-col gap-5">
                    ...
                    <div className="w-full flex flex-row gap-3">
                        <input type="text" placeholder="Input Plat Nomor Kendaraan" className="form-input w-full px-4 py-3 rounded-md basis-5/6"/>
                        <button className="basis-1/6 p-2 w-full bg-red-600 text-white text-sm rounded-xl">{"Check Out"}</button>
                    </div>
                </div>
                <div className="ticket-detail basis-1/3 p-3 rounded-md flex flex-col">
                    <div className="basis-5/6 title text-2xl">
                        ...
                        <div className="flex flex-row mt-1">
                            ...
                            <div className="basis-2/3 text-sm">: <span>BE1234CRF</span></div>
                        </div>
                        <div className="flex flex-row mt-1">
                            <div className="basis-1/3 text-sm">Waktu Check-In</div>
                            <div className="basis-2/3 text-sm">: <span>2024-06-17 16:55:02</span></div>
                        </div>
                        <div className="flex flex-row mt-1">
                            <div className="basis-1/3 text-sm">Waktu Check-Out</div>
                            <div className="basis-2/3 text-sm">: <span>2024-06-17 17:55:02</span></div>
                        </div>
                    </div>
                    <div className="basis-1/6 relative">
                        <div className="flex flex-row mb-2">
                            <div className="basis-1/3 font-bold">Total Price</div>
                            <div className="basis-2/3 font-bold">: <span>Rp 3.000</span></div>
                        </div>
                        <div>
                            <button type="submit" className="absolute inset-x-0 bottom-0 p-2 w-full bg-red-600 text-white text-sm rounded-xl">Bayar Tiket</button>
                        </div>
                    </div>
                </div>
            </div>
